$(function(){
    ...
    $(window).on('hashchange',function(){
        ...
        if(location.hash=='#list'){
            $.ajax({
                url:'/php/ktv/index.php/fenleimanage/show',
                dataType:'json',
    ...
    submit.on('click',function(){
        ...
        console.log(data);
        $.ajax({
            url:'/php/ktv/index.php/fenleimanage/insert',
            data:data,
            method:'post',
            processData:false,
            contentType:false,
    ...
    tbody.on('click','#btn',function(){
        ...
        let ids=tr.attr('id');
        $.ajax({
            url:'/php/ktv/index.php/fenleimanage/delete',
            data:{id:ids},
            success:function(data){
                console.log(data);
                if(data=='ok'){
    ...
    tbody.on('blur','input',function(){
        ...
        $.ajax({
            url:'/php/ktv/index.php/fenleimanage/update',
    ...
    function render(data){
        ...
        data.forEach(v=>{
            ...
            <tr id="${v['sid']}">
                ...
                <td type="simg" style="width:70px;">
                    <img src="${v['simg']}" alt=""style="width:70px;">
                </td>
                <td>
